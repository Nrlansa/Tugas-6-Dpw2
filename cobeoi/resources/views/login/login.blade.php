...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
            ...
            <div class="mb-3">
                <label for="InputEmail1" class="form-label textform">E-mail</label>
            ...
            <div class="mb-3">
                <label for="InputPassword1" class="form-label textform">Password</label>
                <div class="input-group mb-3">
                <span class="input-group-text" id="basic-addon1"><i class="fas fa-unlock-alt"></i></span>
                <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Password">
                </div>
            </div>
            <div style="margin-top: -12px;" class="text-end">
                <a href="lupapass" class="textform text-hover">Lupa Password?</a>
            </div>
        <!--button-->
            ...
            <div class="mt-1">
               <span class="textform">Belum Punya Akun? <a href="daftar" class="textform text-hover">Daftar</a></span>
